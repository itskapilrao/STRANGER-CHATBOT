...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL", "KomalBotsNetwork")
...
STKR = os.environ.get("STKR", "CAACAgIAAxkBAAIBg2S8dd6ICi9_yBrR7Ra6d_XH3mkdAAKnAQACVp29VjeHmTPJ1ZcRLwQ")
